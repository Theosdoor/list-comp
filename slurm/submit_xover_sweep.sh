...
python3 scripts/run_crossover_analysis.py \
   --model 2layer_100dig_64d \
   --sae sae_checkpoints/sweep_xliz4f19/jumprelu_sae_d256_tl05_sp5_lr7e-05_seed1 \
   --feature auto \
   --threshold 0.3 \
   --report
...
python3 scripts/run_crossover_analysis.py \
   --model 2layer_100dig_64d \
   --sae sae_checkpoints/sweep_xliz4f19/jumprelu_sae_d128_tl05_sp5_lr7e-05_seed4 \
   --feature auto \
   --threshold 0.3 \
   --report
...
python3 scripts/run_crossover_analysis.py \
   --model 2layer_100dig_64d \
   --sae sae_checkpoints/sweep_tbxyl1y7/matryoshka_sae_d256_k3_ng2_lr0.0003_seed4 \
   --feature auto \
   --threshold 0.3 \
   --report
...
python3 scripts/run_crossover_analysis.py \
   --model 2layer_100dig_64d \
   --sae sae_checkpoints/sweep_tbxyl1y7/matryoshka_sae_d192_k4_ng4_lr0.0003_seed0 \
   --feature auto \
   --threshold 0.3 \
   --report
...
python3 scripts/run_crossover_analysis.py \
   --model 2layer_100dig_64d \
   --sae sae_checkpoints/sweep_k2bsjr0n/btk_sae_d192_k3_lr0.0003_seed5 \
   --feature auto \
   --threshold 0.3 \
   --report
...
python3 scripts/run_crossover_analysis.py \
   --model 2layer_100dig_64d \
   --sae sae_checkpoints/sweep_k2bsjr0n/btk_sae_d128_k5_lr0.0003_seed0 \
   --feature auto \
   --threshold 0.3 \
   --report
