...
\begin{figure*}[htbp]
    ...
    as in Section \ref{ss:sae_feat_analysis}) differs across SAEs with different sparsities and performance. This includes all SAEs from the sweep in Table \ref{tab:sae_sweep_configs}.
