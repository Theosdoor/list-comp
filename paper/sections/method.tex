...
Because our goal is not out-of-distribution generalisation, we do not need a train/test split. Our goal is instead to determine whether SAEs recover the known internal computation implemented by the transformer.
...
We inspect latent activations using top-activating examples, firing rates, and correlations with the difference between transformer attention weights, \( 
