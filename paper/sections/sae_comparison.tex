...
We use three types of SAEs in this paper.
...
BatchTopK SAEs \citep{bussmann2024batchtopk} keep the top $n \times k$ activations over a batch of $n$ inputs and set the rest to zero. This forces an average of $k$ latent activations per input, so the actual $L_0$ sparsity is approximately $k$. 
