...
\textbf{Future Work.}
The most important next step is determining whether real-world pretrained SAEs learn graded latent activations.
\citet{lieberum2024gemma} and \citet{mcdougall2025gemmascope2} provide a natural test environment in Gemma Scope, which include JumpReLU and Matryoshka SAEs trained on Gemma 2 and Gemma 3 at multiple widths; the same SAE variants we study here. The specific target would be identifying SAE latents in pretrained models where activation magnitude, rather than feature presence, is causally relevant for downstream behaviour.
