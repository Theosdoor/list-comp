...
SAE_TAG = "sae_d128_k3_lr0.001_seed1_2layer_100dig_64d"
SAE_NAME = f"sweep_runs_v2/{SAE_TAG}.pt"
...
xovers_df = pd.read_csv(f'../results/xover/{SAE_TAG}/{SPECIAL_FEAT_IDX}/xovers_feat{SPECIAL_FEAT_IDX}.csv')
swap_bounds_df = pd.read_csv(f'../results/xover/{SAE_TAG}/{SPECIAL_FEAT_IDX}/swap_bounds_feat{SPECIAL_FEAT_IDX}.csv')
swap_results_df = pd.read_csv(f'../results/xover/{SAE_TAG}/{SPECIAL_FEAT_IDX}/swap_results_feat{SPECIAL_FEAT_IDX}.csv')
...
other_scales = {
    ...
    # 82: np.linspace(1.0, 10.0, 100).tolist(),
}
